...
public class AddImagesActivity extends AppCompatActivity implements View.OnClickListener , ConnectivityReceiver.ConnectivityReceiverListener{
    int color;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image1=(ImageView)findViewById(R.id.addImage);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.addImage:
                ...
                showFileChooser1(PICK_IMAGE_REQUEST2);
    ...
    * */
    public void uploadMultipart() {
        ...
        try {
            ...
            new MultipartUploadRequest(this, uploadId, Constants.ADD_IMAGE_URL)
                    .addFileToUpload(path1, "imagePath") //Adding file
                    .addParameter("galleryid", albumid) //Adding text parameter to the request
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(AddImagesActivity.this,"Image Added Successfully",Toast.LENGTH_SHORT).show();

                    Intent gallery =new Intent(AddImagesActivity.this,GalleryActivity.class);
            ...
            Toast.makeText(AddImagesActivity.this, "Please Select image", Toast.LENGTH_SHORT).show();
