...
public class NewsActivity extends AppCompatActivity {
    ...
    private NewsAdapter directoryAdapter;
    private List<NewsItem> directoryItemList = new ArrayList<>();
    TextView txtNoData;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent details =new Intent(NewsActivity.this,AddNewsActivity.class);
                details.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(details);
            }
        });

        recyclerDirectory = (RecyclerView) findViewById(R.id.newsRecycler);
        ...
        directoryAdapter = new NewsAdapter(this, directoryItemList);
    ...
    private void prepareNewsData() {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                Constants.NEWS_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    JSONArray jsonArray1 = response.optJSONArray("newsdata");
                    ...
                    for (int i = 0; i < jsonArray1.length(); i++) {
                        ...
                        directoryItemList.add(new NewsItem(newsid,title,description,postedon));
                        directoryAdapter = new NewsAdapter(NewsActivity.this, directoryItemList);
                        recyclerDirectory.setAdapter(directoryAdapter);
                    ...
                    e.printStackTrace();
                    Toast.makeText(NewsActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
                hidepDialog();
            }
