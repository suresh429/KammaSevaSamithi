...
public class AddEventsActivity extends AppCompatActivity implements View.OnClickListener , ConnectivityReceiver.ConnectivityReceiverListener{
    int color;
    ...
    String tentdate, startDaet, eventName, venue, description;
    Button btnSave;
...
public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
        ...
        ettentdate.setText(dateFormatter.format(newDate.getTime()));
        }
    ...
    private void saveDate() {
        ...
        // tentdate =ettentdate.getText().toString().trim();
        startDaet = etstartDaet.getText().toString().trim();
        venue = etVenue.getText().toString().trim();
        description = etDescription.getText().toString().trim();


        if (!eventName.isEmpty() && !startDaet.isEmpty() && !venue.isEmpty() && !description.isEmpty()) {
    ...
    private void addAdds() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.EVENTS_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Intent pivotal = new Intent(AddEventsActivity.this, EventsActivity.class);
                        pivotal.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(pivotal);
                        Toast.makeText(AddEventsActivity.this, "Event Added Successfully", Toast.LENGTH_LONG).show();
                    }
                },
